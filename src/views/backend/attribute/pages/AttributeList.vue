<template>
    ...
    <el-drawer v-model="drawer" :direction="rtl" size="40%" :with-header="false">
        <h2 class="font-bold mt-6 mb-4 text-xl">Thêm thuộc tính</h2>
        <div>
            <div class="mt-4">
                <el-upload
                    class="upload-demo"
...
<script setup>
import { ref } from 'vue'
import { Search, Document, EditPen, Sell, DeleteFilled, CirclePlus, UploadFilled } from '@element-plus/icons-vue'
