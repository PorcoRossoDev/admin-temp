<template>
    ...
    <div class="bg-white shadow-amber-100 p-5 pt-3 rounded-2xl border border-gray-200 mt-6">
        ...
        <el-tabs>
            <el-tab-pane label="Liên hệ tư vấn">
                <ContactTable />
            </el-tab-pane>
            <el-tab-pane label="Đăng ký tư vấn">
                <RegisterTable />
            </el-tab-pane>
        </el-tabs>
    </div>
...
import ContactTable from '@/views/backend/contact/components/ContactTable.vue'
import RegisterTable from '@/views/backend/contact/components/RegisterTable.vue'
</script>
