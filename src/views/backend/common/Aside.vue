        ...
        <el-menu class="!border-0 !px-4 !mt-[15px] tx-el-menu-aside" router background-color="#fff" text-color="#333" active-text-color="#409EFF"
          ...
          <el-menu-item-group class="mt-2">
            ...
            <el-sub-menu index="2">
              ...
              <el-menu-item :route="{name: 'admin.user'}" index="2-1"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh sách thành viên</el-menu-item>
              <el-menu-item :route="{name: 'admin.category_user'}" index="2-2"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh mục thành viên</el-menu-item>
            </el-sub-menu>
            ...
            <el-sub-menu index="3">
              ...
              <el-menu-item index="3-1"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh sách khách hàng</el-menu-item>
              <el-menu-item index="3-2"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh mục khách hàng</el-menu-item>
            </el-sub-menu>
          ...
          <el-menu-item-group class="mt-2">
            ...
            <el-sub-menu index="6">
              ...
              <el-menu-item index="6-1" :route="{ name: 'admin.product' }"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh sách sản phẩm</el-menu-item>
              <el-menu-item index="6-2" :route="{ name: 'admin.category_product' }"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh mục sản phẩm</el-menu-item>
            </el-sub-menu>
            ...
            <el-sub-menu index="7">
              ...
              <el-menu-item :route="{ name: 'admin.attribute' }" index="7-1"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh sách thuộc tính</el-menu-item>
              <el-menu-item :route="{ name: 'admin.category_attribute' }" index="7-2"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh mục thuộc tính</el-menu-item>
            </el-sub-menu>
            ...
            <el-sub-menu index="8">
              ...
              <el-menu-item index="8-1" :route="{name: 'admin.gallery'}"><el-icon class="!w-3"><ArrowRight /></el-icon>Danh sách media</el-menu-item>
